...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="get-a-quote" href="get-a-quote.html">GitHub</a></li>
        </ul>
      </nav><!-- .navbar -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content order-last  order-lg-first">
            <h3>About Me</h3>
            <p>
              I'am a Back-end Developer, and this project has the goal: Improve my skills with APIs.
            </p>
          </div>
        </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container mt-4">
      <div class="copyright">
        &copy; Copyright <strong><span>JJ Developer</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
